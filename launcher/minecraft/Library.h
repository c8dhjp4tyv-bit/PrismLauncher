...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Timeless Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Timeless Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Timeless Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Timeless Launcher extension - display name
    QString m_displayname;

    /**
     * Timeless Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Timeless Launcher, but could be elsewhere
     * Timeless Launcher specific, because of FTB.
     */
