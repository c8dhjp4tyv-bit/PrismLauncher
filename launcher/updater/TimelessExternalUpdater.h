...
class TimelessExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    TimelessExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~TimelessExternalUpdater() override;
