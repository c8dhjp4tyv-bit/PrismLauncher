...
#define TIMELESS_EXTERNAL_EXE
#include "FileSystem.h"

#include "GitHubRelease.h"

class TimelessUpdaterApp : public QApplication {
    Q_OBJECT
   public:
    enum Status { Starting, Failed, Succeeded, Initialized, Aborted };
    TimelessUpdaterApp(int& argc, char** argv);
    virtual ~TimelessUpdaterApp();
   ...
   private:
    ...
    bool loadLauncherVersionFromExe(const QString& exe_path);
   ...
   private:
    ...
    QString m_launcherBinaryName;
    QString m_launcherVersion;
    int m_launcherVersionMajor = -1;
    int m_launcherVersionMinor = -1;
    int m_launcherVersionPatch = -1;
    QString m_launcherVersionChannel;
    QString m_launcherGitCommit;
