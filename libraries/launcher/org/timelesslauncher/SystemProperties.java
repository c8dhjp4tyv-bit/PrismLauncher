package org.timelesslauncher;

import org.timelesslauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.timelesslauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.timelesslauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.timelesslauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.timelesslauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.timelesslauncher.window.dimensions", windowDimensions);
